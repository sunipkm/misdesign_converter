...
# %%
win = '5577'
wlslice_wide = (557.0,557.5)
wlslice_narrow = (557.0,557.3)
gslice = slice(-4,4)
PLOT = True
#%%
#skyspec
...
#%%
skyda.sum('tstamp').sel(wavelength = slice(557.0,557.5)).plot()
#%%
...
# %%
#skyspec
test = process(skyds, sky_nlp, centralwl=int(win)/10)
...
# %%
#solspec
test = process(solds, sol_nlp, centralwl=int(win)/10)
