...
# %%
# %%
def get_line_profile(da:xr.DataArray, win:str, wlslice_wide:Tuple[float, float], wlslice_narrow:Tuple[float, float], normalize:bool, save:bool) -> Tuple[xr.DataArray, xr.Dataset]:
    ...
    if save:
        ...
        norm.to_netcdf(outdir / f'line_profile_{win}.nc')
...
# %%
win = '6563'
wlslice_wide = (655.3,656.9)
wlslice_narrow = (656.2,656.6)
gslice = slice(-4,4)
PLOT = True
